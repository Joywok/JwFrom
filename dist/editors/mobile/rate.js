...
var _rate = require('jw-components-mobile/lib/rate');
...
require('jw-components-mobile/lib/rate/style');
...
var RateCustom = function (_Component) {
	_inherits(RateCustom, _Component);

	function RateCustom() {
		_classCallCheck(this, RateCustom);

		return _possibleConstructorReturn(this, (RateCustom.__proto__ || Object.getPrototypeOf(RateCustom)).apply(this, arguments));
	}

	_createClass(RateCustom, [{
		key: 'onChange',
		...
		value: function render() {
			...
			var data = Object.assign({
				empty: _react2.default.createElement('i', { className: 'fa fa-star-o' }),
				full: _react2.default.createElement('i', { className: 'fa fa-star' })
			});
