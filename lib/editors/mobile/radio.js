  ...
  render(){
    ...
    for(var i in schema.options){
      if(schema.options[i].hasInput){
        ...
        input = <InputItem className={inputClassName} onClick={(e)=>self.onClick(e)} onFocus={self.onFocus.bind(self)}  onChange={this.inputChange.bind(this)} value={schema.options[i].inputValue}/>
