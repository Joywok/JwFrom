...
class Textarea extends Component {
  ...
  render(){
    ...
    let target = <TextareaItem rows={schema['rows']|| 1} count={schema['count'] || ''} autoHeight={schema['autoHeight']||''} defaultValue={schema['defaultValue']} onChange={value => this.onChange(value, schema)} />;
